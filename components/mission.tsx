...
function Mission() {
  return (
    ...
    //       <div className="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 gap-4 md:gap-6 lg:gap-8 space-y-8">
    ...
    //               Tempore, neque. At consectetur doloremque veniam recusandae
    //               corrupti perferendis hic, omnis soluta eos. Non ducimus
    //               recusandae aperiam quas tempore inventore id nisi rem
    //               molestiae praesentium odio eius delectus, voluptas error eos
    //               earum. Commodi suscipit assumenda tempora iste eos fuga natus
    //               repellat. Ratione esse quam porro iure, a deserunt?
    //             </p>
    //           </div>
    //         </div>
    //         <div className="col-span-full md:col-span-4 lg:col-span-6">
          ...
          <div className="block flex-2">
            ...
            <div className="flex flex-col lg:flex-row gap-6 lg:gap-34">
              ...
              <p className="text-md lg:text-base">
                ...
                Tempore, neque. At consectetur doloremque veniam recusandae
                corrupti perferendis hic, omnis soluta eos. Non ducimus
                recusandae aperiam quas tempore inventore id nisi rem molestiae
                praesentium odio eius delectus, voluptas error eos earum.
                Commodi suscipit assumenda tempora iste eos fuga natus repellat.
                Ratione esse quam porro iure, a deserunt?
              </p>
            </div>
          </div>
        </div>
